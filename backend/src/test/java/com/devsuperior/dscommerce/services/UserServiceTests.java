...
import com.devsuperior.dscommerce.util.CustomerUserUtil;
...
public class UserServiceTests {
    ...
    @Mock
    private CustomerUserUtil customerUserUtil;
    ...
    public void authenticatedShouldReturnUserWhenUserExists(){
        Mockito.when(customerUserUtil.getLoggedUsername()).thenReturn(existingUsername);
    ...
    public void authenticatedShouldThrowUsernameNotFoundExceptionWhenUserDoesNotExist(){
        Mockito.doThrow(ClassCastException.class).when(customerUserUtil).getLoggedUsername();
        Assertions.assertThrows(UsernameNotFoundException.class, () -> {
